# src/experiments/run_poisson_mf_best_k.py
...
def main():
    ...
    plt.legend()
    plt.title("Poisson Factorization RMSE by Split")
    plt.xlabel("K")
    plt.savefig("PF_RMSE.png", dpi=300)
    plt.show()
    ...
    plt.title("Poisson Factorization Log Predictive Likelihood")

    # save to file
    plt.savefig("PF_LPL.png", dpi=300, bbox_inches="tight")
